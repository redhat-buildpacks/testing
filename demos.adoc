...
* [Quarkus and buildpacks](#quarkus-and-buildpacks)
* [Using Pack client](#using-pack-client)
* [Tekton Pipeline and/or extensions](#tekton-pipeline-andor-extensions)
* [RHTAP and PipelineRun + PipelineSpec](#rhtap-and-pipelinerun--pipelinespec)
* [RHTAP and PipelineRun + PipelineRef](#rhtap-and-pipelinerun--pipelineref)
