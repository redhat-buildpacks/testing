...
**WARNING**: You can easily and locally run a kubernetes cluster using https://github.com/kubernetes-sigs/kind[kind] with the scripts developed by the Snowdrop team
```bash
