...
| https://github.com/paketo-buildpacks/builder-jammy-tiny[0.0.176]
| Yes
| Package lifecycle https://github.com/paketo-buildpacks/builder-jammy-tiny/releases/tag/v0.0.176[0.17.0]
