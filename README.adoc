...
To play with the different scenarios using the Quarkus runtime, git clone this project locally.

[,bash]
----
git clone --depth 1 --branch 3.2.5.Final https://github.com/quarkusio/quarkus-quickstarts.git
...
[,bash]
----
kubectl apply -f https://raw.githubusercontent.com/redhat-buildpacks/templates/main/tekton/task/buildpacks-phases/01/buildpacks-phases.yaml
----
====
