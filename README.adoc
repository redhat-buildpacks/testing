...
[,bash]
----
kubectl create -f https://github.com/shipwright-io/build/releases/download/v0.11.0/release.yaml
----
...
[,bash]
----
BUILDER_VERSION=0.0.54
imgpkg copy -i docker.io/paketocommunity/builder-ubi-base:0.0.54 --to-tar ./k8s/builder-$BUILDER_VERSION.tar

imgpkg copy \
  --tar ./k8s/builder-$BUILDER_VERSION.tar \
  --to-repo kind-registry.local:5000/paketocommunity/builder-ubi-base
----
