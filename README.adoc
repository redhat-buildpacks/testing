...
gh repo create --template https://github.com/$GITHUB_ORG_NAME/$REPO_TEMPLATE --clone $GITHUB_ORG_NAME/$REPO_DEMO_NAME --public

rm -rf $GITHUB_REPO_DEMO_NAME
git clone git@github.com:$GITHUB_ORG_NAME/$REPO_DEMO_NAME
cd $REPO_DEMO_NAME
----
